...
public class GalaxyContentClassic {
	...
	private static void processPlanetes(GalaxyModule iGalaxy) {
		...
		Planete lCoruscant = createPlanete("Coruscant", 1100, 735, StarWarsContentDataBase.sCoruscantClassic, iGalaxy, true);
		...
		Planete lHosnianPrime = createPlanete("Hosnian Prime", 1160, 941, StarWarsContentDataBase.sHosnianPrimeClassic, iGalaxy, false);
		...
		Planete lEndor = createPlanete("Endor", 750, 1210, StarWarsContentDataBase.sEndorClassic, iGalaxy, false);
		...
		Planete lJakku = createPlanete("Jakku", 770, 950, StarWarsContentDataBase.sJakkuClassic, iGalaxy, false);
		Planete lTakodana = createPlanete("Takodana", 992, 1111, null, iGalaxy, false);
		...
		Planete lHoth = createPlanete("Hoth", 1025, 1370, StarWarsContentDataBase.sHothClassic, iGalaxy, true);
		...
		Planete lRodia = createPlanete("Rodia", 1585, 1210, StarWarsContentDataBase.sRodiaClassic, iGalaxy, false);
		...
		Planete lGeonosis = createPlanete("Geonosis", 1610, 1240, StarWarsContentDataBase.sGeonosisClassic, iGalaxy, true);
		...
		Planete lNaboo = createPlanete("Naboo", 1400, 1240, StarWarsContentDataBase.sNabooClassic, iGalaxy, false);
		...
		Planete lMalastare = createPlanete("Malastare", 1310, 1220, StarWarsContentDataBase.sMalastareClassic, iGalaxy, true);
		...
		Planete lDQar = createPlanete("D'Qar", 1375, 1320, StarWarsContentDataBase.sDQarClassic, iGalaxy, false);
		...
		Planete lNarShaddaa = createPlanete("Nar Shaddaa", 1630, 870, StarWarsContentDataBase.sNarShaddaaClassic, iGalaxy, false);
		...
		Planete lKashyyyk = createPlanete("Kashyyyk", 1500, 705, StarWarsContentDataBase.sKashyyykClassic, iGalaxy, false);
		...
		Planete lRuusan = createPlanete("Ruusan", 1515, 810, StarWarsContentDataBase.sRuusanClassic, iGalaxy, true);
		...
		Planete lZiost = createPlanete("Ziost", 1575, 370, null, iGalaxy, false);
		...
		Planete lCalamari = createPlanete("Mon Calamari", 1795, 500, StarWarsContentDataBase.sMonCalamariClassic, iGalaxy, false);
		...
		Planete lIego = createPlanete("Iego", 1750, 550, StarWarsContentDataBase.sIegoClassic, iGalaxy, false);
		...
		Planete lZygeria = createPlanete("Zygeria", 1642, 350, StarWarsContentDataBase.sZygerriaClassic, iGalaxy, false);
		Planete lVaynai = createPlanete("Vaynai", 1680, 360, null, iGalaxy, false);
		Planete lFelucia = createPlanete("Felucia", 1617, 470, StarWarsContentDataBase.sFeluciaClassic, iGalaxy, false);
...
//		Planete llKorus = createPlanete("Trogan", 1603, 515, null, iGalaxy, true);
		...
		Planete lSaleucami = createPlanete("Saleucami", 1645, 600, StarWarsContentDataBase.sSaleucamiClassic, iGalaxy, false);
		...
		Planete lDathomir = createPlanete("Dathomir", 1380, 480, StarWarsContentDataBase.sDathomirClassic, iGalaxy, true);
		...
		Planete lIllum = createPlanete("Illum", 730, 540, StarWarsContentDataBase.sIllumClassic, iGalaxy, false);
		...
		Planete lMandalore = createPlanete("Mandalore", 1413, 522, StarWarsContentDataBase.sMandaloreClassic, iGalaxy, true);
	...
	private static void processTerritories(GalaxyModule iGalaxy) {
		...
		lGalacticRepublic22BY.init(StarWarsContentDataBase.sRepubliqueGalactiqueClassic, 685, 192, 130, "galacticrepublic22by", "République Galactique", 272, 320, ElementColor.red);
		
		Territory lSeparatistSpaceNorth22BY = StarWarsApp.ginjector.getTerritory();
		lSeparatistSpaceNorth22BY.init(StarWarsContentDataBase.sCSIClassic, 744, 192, 130, "separatistspacenorth22by", "Espace Séparatiste", 276, 85, ElementColor.blue);
		
		Territory lSeparatistSpaceSouth22BY = StarWarsApp.ginjector.getTerritory();
		lSeparatistSpaceSouth22BY.init(StarWarsContentDataBase.sCSIClassic, 855, 748, 130, "separatistspacesouth22by", "Espace Séparatiste", 112, 217, ElementColor.blue);
		
		Territory lSeparatistSpaceSouthEast122BY = StarWarsApp.ginjector.getTerritory();
		lSeparatistSpaceSouthEast122BY.init(StarWarsContentDataBase.sCSIClassic, 1069, 742, 130, "separatistspacesoutheast122by", "Espace Séparatiste", 65, 48, ElementColor.blue);
		
		Territory lSeparatistSpaceSouthEast222BY = StarWarsApp.ginjector.getTerritory();
		lSeparatistSpaceSouthEast222BY.init(StarWarsContentDataBase.sCSIClassic, 1251, 812, 130, "separatistspacesoutheast222by", " ", 0, 0, ElementColor.blue);
		
		Territory lSeparatistSpaceEast22BY = StarWarsApp.ginjector.getTerritory();
		lSeparatistSpaceEast22BY.init(StarWarsContentDataBase.sCSIClassic, 1068, 317, 130, "separatistspaceeast22by", "Espace Séparatiste", 211, 41, ElementColor.blue);
		...
		lGalacticEmpire19BY.init(StarWarsContentDataBase.sEmpireGalactiqueClassic, 670, 209, 130, "galacticempire19by", "Empire Galactique", 303, 300, ElementColor.blue);
	
		// 4 ABY
		
		Territory lGalacticEmpire4AY = StarWarsApp.ginjector.getTerritory();
		lGalacticEmpire4AY.init(StarWarsContentDataBase.sEmpireGalactiqueClassic, 762, 419, 132, "galacticempire4ay", "Empire Galactique", 206, 65, ElementColor.blue);

		Territory lGalacticEmpireNorth4AY = StarWarsApp.ginjector.getTerritory();
		lGalacticEmpireNorth4AY.init(StarWarsContentDataBase.sEmpireGalactiqueClassic, 1258, 217, 130, "galacticempirenorth4ay", "Empire Galactique", 51, 19, ElementColor.blue);

		Territory lGalacticEmpireEast4AY = StarWarsApp.ginjector.getTerritory();
		lGalacticEmpireEast4AY.init(StarWarsContentDataBase.sEmpireGalactiqueClassic, 1328, 821, 130, "galacticempireeast4ay", "Empire Galactique", 37, -19, ElementColor.blue);
		
		Territory lAllianceTerritories4AY = StarWarsApp.ginjector.getTerritory();
		lAllianceTerritories4AY.init(StarWarsContentDataBase.sAllianceRebelleClassic, 494, 917, 130, "allianceterritories4ay", "Espace de l'Alliance", 0, 0, ElementColor.red);
		
		// 36 AB
		
		Territory lFirstOrder36AY = StarWarsApp.ginjector.getTerritory();
		lFirstOrder36AY.init(StarWarsContentDataBase.sPremierOrdreClassic, 418, 237, 130, "firstorder36ay", "Premier Ordre", 86, 242, ElementColor.blue);

		Territory lNewRepublic36AY = StarWarsApp.ginjector.getTerritory();
		lNewRepublic36AY.init(StarWarsContentDataBase.sNouvelleRepubliqueClassic, 710, 374, 130, "newrepublic36ay", "Nouvelle République", 265, 127, ElementColor.purple);
		
		Territory lResistance36AY = StarWarsApp.ginjector.getTerritory();
		lResistance36AY.init(StarWarsContentDataBase.sResistanceClassic, 974, 942, 130, "resistance36ay", "Résistance", -9, 34, ElementColor.red);
		...
		lPeriod4AY.setText("La bataille d'Endor fut le coup fatal qui disloca l'Empire Galactique. Suite à la mort de l'Empereur, certains dignitaires"
				...
				+ " contre les forces impériales afin de retrouver leur indépendance ou joindre l'Alliance Rebelle. Rapidement, une Nouvelle République fut proclamée.");
		...
		GalaxyPeriod lPeriod36AY = new GalaxyPeriod("Ordre et Résistance");
		lPeriod36AY.setText("Malgré la dislocation de l'Empire Galactique, de nombreuses factions impériales se sont élevées. La plus importante est le Premier Ordre, dirigée par le Leader "
				+ "Suprême Snoke. La bordure extérieure est majoritairement occupées par les vestiges de l'Empire tandis que le coeur galactique est sous le contrôle de la Nouvelle République.");
		lPeriod36AY.getTerritorys().add(lFirstOrder36AY);
		lPeriod36AY.getTerritorys().add(lNewRepublic36AY);
		lPeriod36AY.getTerritorys().add(lHuttSpace19BY);
		lPeriod36AY.getTerritorys().add(lResistance36AY);
		...
		iGalaxy.getGalaxyPeriodInfos().put(36, lPeriod36AY);
	}
